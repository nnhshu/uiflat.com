...
export default function ImageModalPage() {
  ...
  return (
    <div 
        ref={overlayRef}
        className="fixed inset-0 z-50 bg-black/40 backdrop-blur-sm flex items-center justify-center py-10"
        style={{ opacity: 0, transformOrigin: "center" }}
    >
      <div className="relative w-full max-w-5xl mx-auto px-4 py-6 border rounded-4xl border-[#2F323C] bg-[#1A1C21]">
        {/* Close Button */}
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="mt-4 flex gap-4 w-full items-center justify-between">
            <div className="flex text-white items-center gap-2 flex-1">
                ...
                <p className='mb-0'>Use arrow keys for navigation</p>
            </div>
            <div className="flex items-center justify-center gap-2 flex-1">
                <button
                    onClick={handleCopy}
                    className="bg-[#2B2E37 border border-[#2B2E37] text-white px-4 py-2 rounded-full text-sm hover:bg-white/20 transition"
                >
                    Copy
                </button>
                <button
